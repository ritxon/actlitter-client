      ...
      <div className="section-article-white">
        ...
        <div className="contain1280">
          <div className="map-title">
            ...
            <p>
              The map below displays location of waste bins in City of Melbourne
              and suburbs near it. Find a specific type of waste bin near your
              location.
            </p>
          </div>
          ...
          <div className="map-body">
            ...
            <div className="map-index">
              <ul>
                <h4>Map Legend</h4>
                <li>
                  <img src="images/red2.png" alt="General Waste Bin"></img>
                ...
                <li>
                  <img src="images/brown.png" alt="Cigarette Bin"></img>
                  <p className="hashed-text">
                ...
                <li>
                  <img src="images/yellowbin.png" alt="Recycling Bin"></img>
                  <p className="hashed-text">
