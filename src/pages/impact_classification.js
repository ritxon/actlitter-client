        ...
        <div className="impact_article_container w">
          ...
          <div className="impact_article_body">
            ...
            <p>
              ...
              the resource utilization and disposal methods of local waste. For
              example, Germany is generally divided into paper, glass, metal,
              plastic, etc.; Australia is generally divided into compostable
              garbage, recyclable garbage, and non-recyclable garbage; Japan is
              generally divided into combustible garbage and non-combustible
              garbage.
            </p>
            ...
            <p>
              ...
              of through landfill or stacking, even if the garbage is buried far
              away from the living place and the corresponding isolation
              technology is adopted, it is difficult to prevent the penetration
              of harmful substances, which will enter the entire ecosystem along
              with the circulation of the earth. , Pollution of water sources
              and land, through plants or animals, will eventually affect
              people's health.
            </p>
            ...
            <p>
              ...
              use as rubbish. This way of discarding resources is impossible to
              estimate the loss of the entire ecosystem. Before garbage
            ...
            <p>
              ...
              deal with garbage pollution. Garbage classification has become an
