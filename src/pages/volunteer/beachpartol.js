                ...
                <div className="volunteer_bluex">
                    ...
                    <div className="volunteer_part">
                        ...
                        <div className="volunteer_right">
                            ...
                            BeachPatrol is a volunteer group in Melbourne that aims to improve cleanliness of beaches in Melbourne. BeachPatrol is spread over many postcode areas in Melbourne and conducts one activity in each area every month to pick litter from beaches, streets or parks. It collects litter data from these activities and uses it to raise awareness of littering as well as work with the government to provide solutions.
                        </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="volunteer_inter_fats">
                    ...
                    <div className="volunteer_key_facts">
                        ...
                        <img src="../../images/volunteer/fun-fact.png"
                                    className="volunteer_fun_fact"></img>  BeachPatrol has conducted 359 Cigarette Butt Surveys and collected 568,555 cigarettes during their clean-up activities!
                    </p>
                        <p className="organization_details">
                        <img src="../../images/volunteer/fun-fact.png"
                                    className="volunteer_fun_fact"></img>  BeachPatrol has started Love Our Street (LOS) initiative to clean a street in Melbourne to prevent litter from getting into creeks and canals or get blown to beaches.

                    </p>
                        <p className="organization_details">
                        <img src="../../images/volunteer/fun-fact.png"
                                    className="volunteer_fun_fact"></img>  BeachPatrol has enlisted beaches like Brighton, Frankston etc and streets around Melbourne for volunteers to participate in clean-up activities.

                    </p>
                        <p className="organization_details">
                        <img src="../../images/volunteer/fun-fact.png"
                                    className="volunteer_fun_fact"></img>  BeachPatrol has collected 90,000 kgs of rubbish that constitute around 33000 shopping bags of rubbish!
                    ...
                    <div className="previous_event">
                        <div className="previous_list">
                            ...
                            <div className="previous_trans s2">
                                ...
                                <div className="previous_container">
                                    <Transition_cards title="Frankston Pier, Victoria" 
